...
In addition to these operations, constructors and destructors are implemented:
...
And overloaded operators that partially correspond to the operations above:
